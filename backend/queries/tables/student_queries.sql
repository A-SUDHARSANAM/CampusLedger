-- ============================================================
-- CampusLedger — Student Queries Table
-- Depends on: extensions.sql, labs, assets, users
-- Purpose: Students report asset issues without authentication.
--          Issues are auto-assigned to the responsible lab technician.
-- ============================================================
...
-- Index for fast lab-scoped queries (technician dashboard)
